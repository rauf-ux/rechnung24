...
// Onboarding shell — focused single-card with a 3-dot progress indicator.
// Three steps: Unternehmen → Steuerliche Angaben → Logo & Bankdaten.

const STEPS = ['/onboarding/1', '/onboarding/2', '/onboarding/3'];
